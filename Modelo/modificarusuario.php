...
$cadena = array($_SESSION['usuario'], $_SESSION['password'], $_POST['nombre1'], $_POST['nombre2'], $_POST['apellido1'], $_POST['apellido2'], $_POST['cedula'], $_POST['telefono'], $_POST['tipoU'],$_POST['correo'],$_POST['contrasenia']);
